...
public:
    ...
    phasewraith::plugin::PhaseWraithPlugin plugin;
...
void testParameterResponse()
{
    ...
    softParameters[4]->setValue (0.0f);
    ...
    hardParameters[4]->setValue (0.75f);
...
void testStateRoundTrip()
{
    ...
    sourceParameters[4]->setValue (-0.41f);
    ...
    assert (std::fabs (targetParameters[4]->getValue() + 0.41f) <= 1.0e-6f);
}
...
int main()
{
    ...
    std::cout << "PhaseWraithPluginBridgeTests passed\n";
    return 0;
}
